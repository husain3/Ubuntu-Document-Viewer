...
ev_view_annotation_color (EvView  *view)
{
	...
	case EV_ANNOTATION_TYPE_TEXT:
		...
		color_rgba.red = 65535.0 / 65535.0;
		color_rgba.green = 65535.0 / 65535.0;
		color_rgba.blue = 0.0;
		return color_rgba;
	case EV_ANNOTATION_TYPE_TEXT_MARKUP:
		switch (view->adding_annot_info.markup_type)
		{
			case EV_ANNOTATION_TEXT_MARKUP_HIGHLIGHT:
				...
				case EV_ANNOTATION_COLOR_YELLOW:
					...
					color_rgba.red = 65535.0 / 65535.0;
					color_rgba.green = 65535.0 / 65535.0;
					color_rgba.blue = 0.0 / 65535.0;
					return color_rgba;
				case EV_ANNOTATION_COLOR_CYAN:
					color_rgba.alpha = 1.0;
					color_rgba.red = 0.0 / 65535.0;
					color_rgba.green = 65535.0 / 65535.0;
					color_rgba.blue = 65535.0 / 65535.0;
					return color_rgba;
				...
				case EV_ANNOTATION_COLOR_MAGENTA:
					color_rgba.alpha = 1.0;
					color_rgba.red = 65535.0 / 65535.0;
					color_rgba.green = 37522.0 / 65535.0;
					color_rgba.blue = 63993.0 / 65535.0;
					return color_rgba;
				case EV_ANNOTATION_COLOR_NONE:
					color_rgba.alpha = 1.0;
					color_rgba.red = 65535.0 / 65535.0;
					color_rgba.green = 37522.0 / 65535.0;
					color_rgba.blue = 37522.0 / 65535.0;
					return color_rgba;
				}
			case EV_ANNOTATION_TEXT_MARKUP_UNDERLINE:
			      ...
			      EvAnnotationColor annot_color)
{
	...
	if((view->motion.x > 0 && view->motion.y > 0) || (view->selection_info.style > 0))
	{
		...
		parent = GTK_WINDOW (gtk_widget_get_toplevel (GTK_WIDGET (view)));
		ev_view_create_annotation_window(view, view->adding_annot_info.annot, parent);
...
/**
 * ev_view_add_text_markup_annotation_for_selected_text1:
 * @view: #EvView instance
 *
 * Adds a Text Markup annotation (defaulting to a 'highlight' one) to
 * the currently selected text on the document.
